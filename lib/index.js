...
var parseRoot = function (ctx) { return function (policies) { return function (n) {
    return Maybe_1.Maybe
        ...
        .orJust(function () { return Either_1.right(ctx.terms.empty()); })
        .get();
}; }; };
var parseAndOr = function (ctx) { return function (policies) { return function (n) {
    return (exports.ast2Terms(ctx)(policies)(n.left))
        ...
        return (exports.ast2Terms(ctx)(policies)(n.right))
            ...
            .caseOf(ast.And, function () { return ctx.terms.and(ctx)(lv)(rv); })
            .caseOf(ast.Or, function () { return ctx.terms.or(ctx)(lv)(rv); })
            .end(); });
    });
}; }; };
 ...
 */
exports.source2Term = function (ctx) { return function (policies) { return function (source) {
 ...
 */
exports.compile = function (terms) { return function (policies) { return function (options) {
    return function (p) { return function (source) {
        return (exports.source2Term({ terms: terms, policies: policies, options: options })(p)(source))
