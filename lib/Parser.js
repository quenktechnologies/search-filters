...
performAction: function parser__PerformAction(yyloc, yystate /* action[1] */, yysp, yyvstack, yylstack) {
          ...
          switch (yystate) {
case 0:
    /*! Production::    $accept : conditions $end */
...
case 1:
    /*! Production::    conditions : filters EOF */
case 2:
    /*! Production::    conditions : filter EOF */
    ...
    this.$ = new yy.ast.Conditions(yyvstack[yysp - 1], this._$); return this.$;
    break;

case 3:
    /*! Production::    conditions : EOF */
...
case 9:
    /*! Production::    filter : FIELD ":" operator value */
...
case 23:
    /*! Production::    string_literal : QUOTE STRING_LITERAL QUOTE */
    ...
    this.$ = new yy.ast.StringLiteral(yyvstack[yysp - 1], this._$);
    break;

case 24:
    /*! Production::    string_literal : FIELD */
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 21:
        /*! Conditions:: INITIAL */
        /*! Rule::       " */
        this.begin('STRING_LITERAL');

        return 15;
        break;

      case 23:
        /*! Conditions:: STRING_LITERAL */
        /*! Rule::       ["] */
        this.popState();
    ...
    rules: [
      ...
      /*  5: */  /^(?:AND|and)/,
      /*  6: */  /^(?:([$A-Z_a-z][\w$\-.\\]*))/,
      /*  7: */  /^(?:((?:([-]?(?:[-]?([0]|((?:[1-9])(?:\d+)*)))\.(?:\d+)*(?:(?:[Ee])(?:[+-]?\d+))?)|(\.(?:\d+)(?:(?:[Ee])(?:[+-]?\d+))?)|((?:[-]?([0]|((?:[1-9])(?:\d+)*)))(?:(?:[Ee])(?:[+-]?\d+))?))|(?:[0][Xx](?:[\dA-Fa-f])+)|(?:[0](?:[0-7])+)))/,
      /*  8: */  /^(?:\()/,
      /*  9: */  /^(?:\))/,
      /* 10: */  /^(?::)/,
      /* 11: */  /^(?:\[)/,
